export default function Sponsors() {
	return (
		<section
			id="sponsors"
			className="sponsors w-full h-auto col-span-12 flex flex-col gap-12 items-center justify-center my-20">
			<div className="flex flex-col gap-16 my-10 items-center justify-center ">
				<h1 className="text-5xl uppercase font-black ">Casa Editorial</h1>
				<img
