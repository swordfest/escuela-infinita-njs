...
export default function Sumario(props: any) {
    ...
    return (
        // h-[80vh]
        <section  id="sumario" className="sumario show w-full h-auto col-span-12 gap-8 xl:gap-24 flex flex-col xl:flex-row items-center justify-center pt-8 pb-24 mt-24 ">
            <div className={"w-full h-full flex flex-col items-center xl:items-start gap-4 text-justify leading-8 transition-all"}>
            {/* translate-y-10 */}
                <h1 className="text-3xl text-[#162330] xl:text-5xl uppercase font-black ">Síntesis</h1>
                <p>
            ...
            <div className="w-full h-full flex flex-col items-center xl:items-end justify-end gap-4 leading-8  ">
                <h1 className=" text-3xl xl:text-5xl text-[#162330] uppercase font-black " >Sumario</h1>
