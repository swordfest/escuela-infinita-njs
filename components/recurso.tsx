...
export default function Recurso(props: any) {
	...
	if (props.type === "enlace") {
		return (
			<div className="w-full h-[640px] col-span-4 flex flex-col justify-between gap-4 group bg-white shadow-lg ">
				<div className="flex flex-col gap-1">
					<div className={"img-wrapper relative w-full h-56 "}>
						<Image className="object-cover object-top" src={props.image} fill alt={"aaa"} />
					</div>
					<h2 className=" text-xl font-bold group-hover:text-[#2d2b5c] px-4 py-2 ">
						{props.title}
					</h2>
					...
					<span className="flex gap-2 items-center font-semibold text-[#7a7a7a] px-4 ">
						<svg className="w-4 h-4 fill-[#7a7a7a] " viewBox="0 0 24 24">
	...
	if (props.type === "documento") {
		return (
			<div className="w-full h-[640px] col-span-4 flex flex-col justify-between gap-4 group bg-white shadow-xl ">
				<div className="flex flex-col gap-1">
					<div className={"img-wrapper relative w-full h-56 "}>
						<Image className="object-cover object-top" src={props.image} fill alt={"aaa"} />
					</div>
					...
					{/* <span className="flex gap-2 items-center font-semibold text-[#7a7a7a] ">
						<svg className="w-4 h-4 fill-[#7a7a7a] " viewBox="0 0 24 24">
							<path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path>
						</svg>
						{props.autor1}
