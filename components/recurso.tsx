...
export default function Recurso(props: any) {
	...
	if (props.type === "enlace") {
		return (
			<div className="w-full h-[380px] col-span-3 flex flex-col gap-4 group justify-between ">
				<div className="flex flex-col gap-1">
					<div className={"img-wrapper relative w-full h-40 "}>
						<Image src={props.image} fill alt={"aaa"} />
					</div>
					<h2 className=" text-xl font-bold group-hover:text-[#2d2b5c] ">
						{props.title}
					</h2>
	...
	if (props.type === "documento") {
		return (
			<div className="w-full h-[380px] col-span-3 flex flex-col justify-between gap-4 group ">
				<div className="flex flex-col gap-1">
					<div className={"img-wrapper relative w-full h-40 "}>
						<Image src={props.image} fill alt={"aaa"} />
					</div>
